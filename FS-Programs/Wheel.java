...
// You are given an array customers of length n where customers[i] is the number of new customers arriving 
// just before the ith rotation (0-indexed). 
...
// Each customer pays boardingCost dollars when they board on the gondola closest to the ground 
// and will exit once that gondola reaches the ground again.
...
// in order to get all the customers down safely. Note that if there are currently more than four customers
// waiting at the wheel, only four will board the gondola, and the rest will wait for the next rotation.
...
// 1. 8 customers arrive, 4 board and 4 wait for the next gondola, the wheel rotates.
