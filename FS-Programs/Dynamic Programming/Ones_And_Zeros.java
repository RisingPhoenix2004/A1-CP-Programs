...
class SpaceFleet {
    public static int maxSubset(String[] containers, int fl, int ol) {
        ...
        for (int f = fl; f >= fc; f--) {
                for (int o = ol; o >= oc; o--) {
                    dp[f][o] = Math.max(dp[f][o], dp[f - fc][o - oc] + 1);
                }
            }
        }
        return dp[fl][ol];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(maxSubset(containers, fuelLimit, oxygenLimit));
    }
}