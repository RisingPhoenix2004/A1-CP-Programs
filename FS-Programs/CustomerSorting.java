...
class Customer implements Comparable<Customer> {
    ...
    public int compareTo(Customer customer) {
        Integer.compare(this.id,customer.id);
...
public class CustomerSorting {
    public static void main(String[] args) {
        ...
        //WRITE YOUR CODE HERE
        byIdBill.sort(Comparator.comparing(Customer::getId).thenComparing(Customer::getBill));
		...
		//WRITE YOUR CODE HERE
		byBillDescName.sort(Comparator.comparing(Customer::getBill).reversed().thenComparing(Customer::getName));
